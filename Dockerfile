...
RUN set -ex; \
    ...
    echo "find ${APP_ROOT} ${FILES_DIR} -maxdepth 0 -uid 0 -type d -exec chown deploy:deploy {} +" > /usr/local/bin/init_volumes; \
    ...
    \
    chown deploy:deploy /usr/share/nginx/html/50x.html; \
    \
